...
export const languageCn = `
  <svg viewBox="0 0 24 24">
    ...
    <rect x="11" y="11" width="12" height="12" rx="2" fill="#dc3545"/>
    <text x="17" y="21" font-size="10" font-weight="bold" text-anchor="middle" fill="white" font-family="sans-serif">zh</text>
  </svg>
`
...
export const languageEn = `
  <svg viewBox="0 0 24 24">
    ...
    <line x1="2" y1="17" x2="22" y2="17" stroke="currentColor" stroke-width="1"/>
    <rect x="11" y="11" width="12" height="12" rx="2" fill="#dc3545"/>
    <text x="17" y="21" font-size="10" font-weight="bold" text-anchor="middle" fill="white" font-family="sans-serif">EN</text>
  </svg>
`